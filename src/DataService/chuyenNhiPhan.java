//[Mã câu hỏi (qCode): QxQtOQY5].  Một dịch vụ web (hỗ trợ SOAP version 1.1) được định nghĩa và mô tả trong tệp DataService?wsdl, được triển khai trên server tại URL http://<Exam_IP>:8080/JNPWS/DataService?wsdl để xử lý các bài toán với dữ liệu nguyên thủy.
...
public class chuyenNhiPhan {
    public static void main(String[] args) throws Exception{
        String studentCode = "B22DCCN008",qCode = "QxQtOQY5";
